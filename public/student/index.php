...
<aside class="px-4 mt-4 mb-4" style="width:100%">
    ...
    <div class="row">
        <div class="col"></div>
        <div class="col-5 ">
            <h3 class="text-center">Welcome to student Online-Examnation-System!</h3>
            <div class="">
                <form id="login" class="was-validated" method="POST" action="" style="display: inline;">
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Email</label>
                        <input name="user_email" type="email" class="form-control is-valid" id="email"  required>
                    ...
                    <div class="mb-3">
                        ...
                        <input name="user_password" type="password" class="form-control is-valid" id="password" required>
