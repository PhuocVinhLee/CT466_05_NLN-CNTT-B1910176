...
<table id="contacts" class="table table-bordered table-responsive table-striped">
						<thead>
							<tr>
								...
								<th>Tên lớp học</th>
                                <th>Mã giáo viên</th>
                                <th>Tham gia vào khóa học</th>
							</tr>
						</thead>
						<tbody>
							<?php foreach ($study_classs as $study_class) : ?>			
                                <tr>
									<td><?= htmlspecialchars($study_class->study_class_id) ?></td>
									<td><?= htmlspecialchars($study_class->study_class_name) ?></td>
