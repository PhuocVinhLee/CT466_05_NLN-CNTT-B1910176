...
$exam = new exam($PDO);
$exams = $exam->all_teacher_id_study_class_id($_GET['teacher_id'], $_GET['study_class_id']);
						...
						<tbody>
							<?php foreach ($exams as $exam) : ?>			
                                <tr>
                                    ...
                                    <td><a href="test.php?exam_id=<?=$exam->get_Exam_Id()?>"><button type="button" class="btn btn-primary">Thi</button></a></td>
