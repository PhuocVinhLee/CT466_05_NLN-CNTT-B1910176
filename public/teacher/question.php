...
$study_classes = $study_class->all();
$study_classes1 = $study_class->all();

use CT275\Labs\level_question;

$level_question = new level_question($PDO);
$level_questions = $level_question->all();
...
<aside id="aside" class="px-4 mt-4 mb-4" style="width:100%">
    ...
    <a class="btn btn-primary mt-3 mb-3 " data-bs-toggle="modal" data-bs-target="#staticBackdropAddUser">
        <i class="fa fa-plus"></i> Thêm câu hỏi</a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="row g-3 was-validated" method="post" id="question_add">
                        <input type="text" hidden id="question_add_form" name="question_add_form" value="question_add_form">
                        <div class="col-md-12">
                            <label for="validationServer" class="form-label">Tên câu hỏi</label>
                            <input type="text" class="form-control is-valid" name="question_title" required>
                            <div class="invalid-feedback">Vui lòng nhập tên kỳ thi</div>
                        </div>
                        <div class="col-md-12">
                            <label for="validationServer" class="form-label">Đáp án A</label>
                            <input type="text" class="form-control is-valid" name="option_title_1" required>
                            <div class="invalid-feedback">Vui lòng nhập tên kỳ thi</div>
                        </div>
                        <div class="col-md-12">
                            <label for="validationServer" class="form-label">Đáp án B</label>
                            <input type="text" class="form-control is-valid" name="option_title_2" required>
                            <div class="invalid-feedback">Vui lòng nhập tên kỳ thi</div>
                        </div>
                        <div class="col-md-12">
                            <label for="validationServer" class="form-label">Đáp án C</label>
                            <input type="text" class="form-control is-valid" name="option_title_3" required>
                            <div class="invalid-feedback">Vui lòng nhập tên kỳ thi</div>
                        </div>
                        <div class="col-md-12">
                            <label for="validationServer" class="form-label">Đáp án D</label>
                            <input type="text" class="form-control is-valid" name="option_title_4" required>
                            <div class="invalid-feedback">Vui lòng nhập tên kỳ thi</div>
                        </div>
                        <div class="col-md-12">
                            <label for="validationServer" class="form-label">Đáp án đúng</label>
                            <select class="form-select" name="answer_option" required aria-label="select example">                            
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="level_id" required aria-label="select example">
                                <?php foreach ($level_questions as $level_question) : ?>
                                    <option value="<?= htmlspecialchars($level_question->getId()) ?>"><?= htmlspecialchars($level_question->level_question) ?></option>
                                <?php endforeach ?>
                            </select>
                            <div class="invalid-feedback">Vui lòng chọn môn thi</div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        function exam_add() {
            $(document).on('submit', '#question_add', function(event) {
                event.preventDefault();
                let question_add = document.getElementById("question_add");
                let form_question_add = new FormData(question_add);
                $.ajax({
                    url: "../ajax/question.php",
                    data: form_question_add,
                    cache: false,
                    processData: false,
                    contentType: false,
                    type: 'POST',
