...
$admin= new admin($PDO);
$admin->find_adimn_id($_SESSION['admin_id']); 
 ?>
...
<h2 class="section-heading text-center wow fadeIn" data-wow-duration="1s">Thông tin người dùng</h2>
      <form class="row g-3 was-validated mt-3">
        <div class="col-md-6">
          ...
          <input type="text" class="form-control is-valid" id="validationServer01" value="<?=$admin->admin_name?>" required>
        ...
        <div class="col-md-6">
          ...
          <input type="email" class="form-control is-valid" id="validationServer02" value="<?=$admin->admin_email?>" required>
          <div class="invalid-feedback">Vui lòng nhập Email</div>
        </div>
        <div class="col-md-6">
          <label for="validationServer02" class="form-label">Password</label>
          <input type="password" class="form-control is-valid" id="validationServer02" value="<?=$admin->admin_password?>" required>
